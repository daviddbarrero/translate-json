...
## Change to other language you can set the output language by changing this :

```python
16 >>> # Change output language by adding this to the next line :
17 >>> translation = translator.translate(data[i], *LANGUAGE OF OUTPUT*  
```
Languages available :
<pre> 
LANGUAGES = {
